...
namespace DataAccesLayer.Migrations
{
    ...
    [Migration("20220913171507_operation claimdescriptionadded")]
    partial class operationclaimdescriptionadded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Concrete.AccountReconcillationsDetail", b =>
                {
                    ...
                    b.Property<int?>("AccountReconcillationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AccountReconcillationId");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.RegisterTerms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EntityLayer.Concrete.AccountReconcillationsDetail", b =>
                {
                    b.HasOne("EntityLayer.Concrete.AccountReconcillation", "AccountReconcillation")
                        .WithMany("AccountReconcillationsDetail")
                        .HasForeignKey("AccountReconcillationId");

                    b.HasOne("EntityLayer.Concrete.Currency", "Currencies")
                        .WithMany("AccountReconcillationsDetail")
                        .HasForeignKey("CurrencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
